...
def start_timer():
    ...
    if reps % 8 == 0:
        ...
        title_check.config(text=check_string * math.floor(reps / 2))
...
title_check = Label(fg=GREEN, bg=YELLOW, font=(FONT_NAME, 35, "bold"))
title_check.grid(column=1, row=3)
